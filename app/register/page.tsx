...
import { Loader2, User, Lock, Mail, UserCircle, Github } from "lucide-react";

export default function RegisterPage() {
  const router = useRouter();
  const { register, isAuthenticated, isLoading, error, clearError, checkAuth } =
    useAuthStore();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 p-4">
      <div className="w-full max-w-5xl bg-white dark:bg-gray-900 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        {/* Left Panel - Registration Form */}
        <div className="md:w-[55%] flex items-center justify-center p-6 md:p-10 bg-white dark:bg-gray-900 order-2 md:order-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 pl-4 pr-12 rounded-xl border-gray-200 dark:border-gray-700 focus:border-[#5B5FC7] focus:ring-[#5B5FC7]/20 bg-gray-50 dark:bg-gray-800"
                />
                <UserCircle className="absolute right-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
              </div>
              ...
              {/* Mobile Login Link */}
              <p className="text-sm text-center text-gray-500 md:hidden pt-2">
        ...
        <div className="md:w-[45%] relative min-h-[250px] md:min-h-[600px] overflow-hidden order-1 md:order-2">
          {/* Background Image */}
          <Image
            src="/liverpoolB.jpeg"
          ...
          />
          {/* Dark Overlay */}
          <div className="absolute inset-0 bg-gradient-to-bl from-[#5B5FC7]/90 via-[#5B5FC7]/70 to-black/60" />
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-6">
            ...
            <p className="text-white/90 mb-6 text-sm max-w-xs">
              Continue your journey with temporal network analysis and
              visualization
            </p>
